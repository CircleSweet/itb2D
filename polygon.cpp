...
void map_translation(std::vector<polygon> polygons,int x,int y) {
...
//   gku.draw(f,1,2);
//   p3.draw(f,1,2);
//   p4.translation(-5,5); p4.draw(f,1,2); p4.draw_fill(f,620,270,120,0,0);
//   p5.draw(f,1,2);
//   p6.draw(f,1,2);
//   p7.draw(f,1,2);
//   p8.draw(f,1,2);
